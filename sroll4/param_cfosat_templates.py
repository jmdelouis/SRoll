...
def main():
  ...
  ### INPUTS
  Mask = "/export/home1/jmdeloui/CFOSAT/CFOSAT_MASK_128"
  ...
  projectionType = "cfosatmap"#"Q,U" #"I"#"I,Q,U"
  ...
  DipOrb_noPS = ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_diporb_quat"%(i) for i in old_bolo]  # remplace by Wavewatch model
  number_of_DipOrb_noPS =len(DipOrb_noPS) #-- Calib-temp


  Hit_noPS = ["/export/home1/jmdeloui/CFOSAT/CFOSAT_%s_Hit"%(i) for i in bolo]
  ...
  Theo_noPS = ["/export/home1/jmdeloui/CFOSAT/CFOSAT_%s_H%d"%(i,j) for j in range(4) for i in bolo]
