...
def main(): 
  ...
  """
  ### INPUTS
  Mask = "/export/home1/jmdeloui/DATA4SROLL4/mask_RD_857"
  ...
  #for j in range(2):
  #  Theo_HPR = Theo_HPR + ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_TMPFSL_%d.float32.bin"%(i,j) for i in bolo]
  
  Theo_MAP = ['/export/home1/jmdeloui/DATA4SROLL4/NEW_cleaned_12CO.float32.bin',
              '/export/home1/jmdeloui/DATA4SROLL4/NEW_cleaned_13CO.float32.bin']

  Theo_MAP = ['/export/home1/jmdeloui/DATA4SROLL4/NEW_cleaned_12CO.float32.bin',
              '/export/home1/jmdeloui/DATA4SROLL4/FREE_FREE_mod.float32.bin',
              '/export/home1/jmdeloui/DATA4SROLL4/Dust_New_I']
  
  #Sub_HPR = ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_fsl"%(i) for i in bolo]
