...
nfile_I = '/export/home/tfoulquier/MAP/857_maps/temp_OUT2048_test2_rstep1_input_REP6_857GHz_I_crab_full_0.fits'
nfile_Q = '/export/home/tfoulquier/MAP/857_maps/temp_OUT2048_test2_rstep1_input_REP6_857GHz_I_crab_full_1.fits'
nfile_U = '/export/home/tfoulquier/MAP/857_maps/temp_OUT2048_test2_rstep1_input_REP6_857GHz_I_crab_full_2.fits'
...
"""
hp.mollview(im353_I,cmap="jet",min = -0.01,max = 0.01,title ='im353_I') 
hp.mollview(im353_Q,cmap="jet",min = -0.01,max = 0.01,title ='im353_Q') 
hp.mollview(im353_U,cmap="jet",min = -0.01,max = 0.01,title ='im353_U') 
"""
#hp.mollview(im353ds2,cmap="jet",min = -0.01,max = 0.01,title ='im353ds2') 
hp.mollview(im_I,cmap='jet',min = 0,max=100,title =name_I )
hp.mollview(im_Q,cmap='jet',min = -70,max=70,title =name_Q )
hp.mollview(im_U,cmap='jet',min = -70,max=70,title =name_U )



hp.gnomview(im2_I,cmap='jet',rot=[ph_gal,th_gal],min = 0,max = 100,title ="ODUST I" )
hp.gnomview(im2_Q,cmap='jet',rot=[ph_gal,th_gal],min = -30,max = 30,title ="ODUST Q" )
hp.gnomview(im2_U,cmap='jet',rot=[ph_gal,th_gal],min = -30,max = 30,title ="ODUST U" )

hp.gnomview(im_I,cmap='jet',rot=[ph_gal,th_gal],min = 0,max = 100,title =name_I )
hp.gnomview(im_Q,cmap='jet',rot=[ph_gal,th_gal],min = -1,max = 1,title =name_Q )
hp.gnomview(im_U,cmap='jet',rot=[ph_gal,th_gal],min = -1,max = 1,title =name_U )
#hp.gnomview(im353ds1,cmap='jet',rot=[ph_gal,th_gal],min = -0.01,max = 0.01,title ='im353ds1' )
