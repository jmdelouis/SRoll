...
def main(): 
  ...
  """  
  a=[6.80195,-4.63153,8.18157,7.41512,]
  b=[3.99432,5.87868,-0.733149,3.09842,]
  ...
  Mask = "/export/home/tfoulquier/python_scripts/carina_mask2"


  projectionType ="I,Q,U" #'I857' # "I" #
  in_template_map= []
  ...
  Badring = ["/export/home/tfoulquier/python_scripts/carina2_discarded_rings_%s"%(i) for i in bolo]
  ...
  #Theo_HPR = Theo_HPR + ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_GRAD2"%(i) for i in bolo]
  #Theo_HPR = Theo_HPR + ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_GRAD3"%(i) for i in bolo]

  #Theo_HPR = Theo_HPR + ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_PDUST"%(i) for i in bolo]
  #Theo_HPR = Theo_HPR + ["/export/home1/jmdeloui/DATA4SROLL4/%s_REP6_ODUST"%(i) for i in bolo]
  ...
  ### OUTPUTS
  bolo_map = ['test_carina2_rstep1_input_REP6_857GHz_%s'%projectionType ]#,'857-1','857-2','857-3','857-4']
