...
def main():
  ...
  MAP = ["/export/home/tfoulquier/MAP/857_maps/%s%s"%(OMAP,i) for i in bolo_map]
  Out_VEC = ["/export/home/tfoulquier/VEC/857_vecs/%s%s_offset"%(OMAP,i) for i in bolo]
  Out_Offset = ["/export/home/tfoulquier/VEC/857_vecs/%s%s_offset"%(OMAP,i) for i in bolo]
  Out_Offset_corr = ["/export/home/tfoulquier/VEC/857_vecs/%s%s_offset_corr"%(OMAP,i) for i in bolo]
  Out_xi2 = ["/export/home/tfoulquier/VEC/857_vecs/%s%s_xi2"%(OMAP,i) for i in bolo]
  Out_xi2_corr = ["/export/home/tfoulquier/VEC/857_vecs/%s%s_xi2_corr"%(OMAP,i) for i in bolo]
