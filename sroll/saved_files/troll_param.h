...
typedef struct {
  ...
  /* ---- Parameter CNN_NUM_EPOCHS -----------------------------------------
   *
   */
  PIOINT CNN_NUM_EPOCHS;
  
  /* ---- Parameter CNN_EVAL_FREQ -----------------------------------------
   *
   */
  PIOINT CNN_EVAL_FREQ;

  /* ---- Parameter CNN_LEARNING_RATE -----------------------------------------
   *
   */
  PIODOUBLE CNN_LEARNING_RATE;

  /* ---- Parameter CNN_DECAY_RATE -----------------------------------------
   *
   */
  PIODOUBLE CNN_DECAY_RATE;

  /* ---- Parameter CNN_BATCHSZ -----------------------------------------
   *
   */
  PIOINT CNN_BATCHSZ;
  ...
  /* ---- Parameter CNN_NDCONV -----------------------------------------
   *
   */
  PIOINT CNN_NDCONV;
  
  /* ---- Parameter CNN_KERNELSZ -----------------------------------------
   *
   */
  PIOINT CNN_KERNELSZ;
  ...
  /* ---- Parameter CNN_NPAR_FC -----------------------------------------
   *
   */
  PIOINT CNN_NPAR_FC;
  
  /* ---- Parameter CNN_DO_RELU -----------------------------------------
   *
   */
  PIOINT CNN_DO_RELU;
  
  /* ---- Parameter CNN_DO_FULLY_CONNECTED -----------------------------------------
   *
   */
  PIOINT CNN_DO_FULLY_CONNECTED;
  ...
  /* ---- Parameter CNN_NORMALIZE_DATA_IN_LOSS -----------------------------------------
   *
   */
  PIOINT CNN_NORMALIZE_DATA_IN_LOSS;
  
  /* ---- Parameter CNN_HUBER_LOSS_DELTA -----------------------------------------
   *
   */
  PIODOUBLE CNN_HUBER_LOSS_DELTA;

  /* ---- Parameter CNN_TEST_CONVERGENCE -----------------------------------------
   *
   */
  PIOINT CNN_TEST_CONVERGENCE;

  /* ---- Parameter CNN_NO_NET -----------------------------------------
   *
   */
  PIOINT CNN_NO_NET;

  /* ---- Parameter CNN_RANDSEED -----------------------------------------
   *
   */
  PIOINT CNN_RANDSEED;
   ...
   */
  PIOINT FSLCNN;
  PIOBYTE flag_FSLCNN;  /* ==_PAR_TRUE if PHASECNN is present */ 
  ...
  /* ---- Parameter CNN_DO_TRANSFER_LEARNING -----------------------------------------
   *
   */
  PIOINT CNN_DO_TRANSFER_LEARNING;
  

  /* ---- Parameter CNN_DO_SAVE_WEIGHTS -----------------------------------------
   *
   */
  PIOINT CNN_DO_SAVE_WEIGHTS;
