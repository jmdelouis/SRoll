...
def init_network(mynetwork,signal,weights,TCO1,TSI1,MAT0,MAT1,MAT2,hidx,idx,realpix,in_param,in_convw,in_convb,in_flw,in_flb):
    ...
    mapq=np.load('/scratch/cnt0028/ias1717/SHARED/RD12_data/dmc/MISS03/DATA/sroll_templates/MAP_JMD_2048/DUSTMODEL_857_Q.npy').astype('float32')
    mapu=np.load('/scratch/cnt0028/ias1717/SHARED/RD12_data/dmc/MISS03/DATA/sroll_templates/MAP_JMD_2048/DUSTMODEL_857_U.npy').astype('float32')
