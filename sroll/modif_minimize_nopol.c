    ...
    if (ndata>0&&flgpix[k]>0) {
      ...
      for (l1=0;l1<ndata;l1++) {
        ...
        if (flg_rg[htmp[l1].ib][ri1]!=0) {
          htmp[l1].wp=0;
	        //init calcul signal
          if (REMHDIP==0) htmp[l1].M =(htmp[l1].sig*g1-htmp[l1].fsl-htmp[l1].dip-htmp[l1].corr_nl-htmp[l1].corr_cnn);
          //SI+=htmp[l1].w*(htmp[l1].sig*g1-htmp[l1].fsl-htmp[l1].dip-htmp[l1].corr_nl-htmp[l1].corr_cnn); // Calcul du signal 
          else  htmp[l1].M =(htmp[l1].sig*g1-htmp[l1].fsl-htmp[l1].freefree-htmp[l1].corr_nl-htmp[l1].corr_cnn);
...
//################################################################################################################ //       ################################################################################################################ / ################################################################################################################// ################################################################################################################// ################################################################################################################// ################################################################################################################
  while ((iter < itermax)  && ((delta_new) > delta0*1E-24) && ((delta_new) > 1E-20)) //Param->XI2STOP)) // ie  for k in range(iterMax):
    {
      // q <= Ad
